...
@Component({
  ...
  template: `<div class="card p-6 max-w-4xl mx-auto">
    ...
    <p class="text-muted-foreground mt-2">Use the navigation to explore the app. This demo focuses on offline-first storage, transactions, budgets, and admin tools.</p>
  </div>`
})
class HomeComponent {}
...
export const routes: Routes = [
  ...
  { path: 'app', component: ShellComponent, children: [
    ...
    { path: 'transactions', loadComponent: () => import('./pages/transactions.page').then(m => m.TransactionsPage) },
    { path: 'accounts', loadComponent: () => import('./pages/accounts.page').then(m => m.AccountsPage) },
    { path: 'categories', loadComponent: () => import('./pages/categories.page').then(m => m.CategoriesPage) },
    { path: 'budgets', loadComponent: () => import('./pages/budgets.page').then(m => m.BudgetsPage) },
    ...
    { path: 'trash', loadComponent: () => import('./pages/trash.page').then(m => m.TrashPage) },
  ]},
